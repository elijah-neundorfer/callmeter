...
public class ClearCommAdapter extends RecyclerView.Adapter<ClearCommAdapter.ClearCommHolder> {
    ...
    ArrayList<DataAccessDescriptor> dataAccessDescriptors = new ArrayList<DataAccessDescriptor>() {{
        ...
        add(new DataAccessDescriptor(
                ...
                "Phone State",
                "determine the current state of the phone",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "capture information regarding new SMS messages and display it",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Device Boot Status",
                "determine when the device boots up (powers on)",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Device Wake/Sleep Status",
                "prevent the device from falling asleep while using the app",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Edit Call Log",
                "edit information regarding your phone calls",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Edit Device Logs",
                "write information regarding your device logs",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Read Device Logs",
                "read information regarding your device logs",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Internet Access",
                "retrieve and display ads from the internet",
                false,
                false,
                "N/A",
                true,
                "retrieve ads provided by third parties"
        ));
        add(new DataAccessDescriptor(
        ...
        add(new DataAccessDescriptor(
                ...
                "Location of Device Storage and External Storage Devices",
                "locate device storage utilities to save app data",
                false,
                false,
                "N/A",
                false,
    ...
    private final static Map<String, String> dangerousPermissionGroups = new HashMap<String, String>() {
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                put(Manifest.permission.ACCESS_BACKGROUND_LOCATION, "Location");
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
